...
_COPYSPRT   LDA SPRITEDATA,X
            ...
            LDA #(0+12)         ; set initial left bat sprite X position
            STA SPR0_X 
            STA SPR0_X+4       
            ...
            LDA #(12*12+12)      ; set initial right bat sprite X position
            STA SPR0_X+8 
            STA SPR0_X+12       
...
.BYTE %00_00_00_00, %00_00_00_00, %01_01_01_01 ; bat sprite (pixels right)
...
.BYTE %01_01_01_01, %00_00_00_00, %00_00_00_00 ; bat sprite 2 (pixels left)
